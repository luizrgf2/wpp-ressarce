...
async function stage2(client,message,socket){
    ...
    if(estado == null){
        ...
        if(message.body == '1'){
            ...
            await Red.create({userid:message.from,red:'Estado do procedimento',conversas:['Opçao 3, verificar o andamento do procedimento do cliente.'],nome:user.nome,area:'Suporte'}) // salva no banco de dados que esta interessado em conversar com um atendente
