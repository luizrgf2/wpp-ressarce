...
async function stage2(client,message){
    ...
    if(estado == null){
        ...
        if(message.body == '1'){
            ...
            await Red.create({userid:message.from,red:'Falar com jurídico cliente'}) // salva no banco de dados que esta interessado em conversar com um atendente
        ...
        //redirecionar para um atendente ressarce
            ...
            await client.sendText(message.from,dates.stage1) // aguarde um atendente ressarce
            await Red.create({userid:message.from,red:'Falar com jurídico franqueado'}) // salva no banco de dados que esta interessado em conversar com um atendente
